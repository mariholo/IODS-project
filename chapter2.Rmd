...
## Analysis 1. The structure and the dimensions of the data
...
## Analysis 2.  A graphical overview of the data and summaries of the variables in the data
...
## Analysis 3 and 4. Regression analyses.
...
##Analysis 5. The diagnostic plots
